...
function getHashTiedTo($file) {
   $request = xmlrpc_encode_request("d.multicall",array("main","d.get_hash=","d.get_tied_to_file="));
...
function getByCustom($cust) {
   $request = xmlrpc_encode_request("d.multicall",array("main","d.get_custom1=","d.get_hash="));
   $response = do_xmlrpc($request);
...
function percentbar($percent) {
   $retvar="<table align=center border=0 cellspacing=0 cellpadding=1 bgcolor=#666666 width=100%><tr><td align=left>";
